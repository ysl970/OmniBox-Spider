...
const API_HOST = 'https://lbapiby.com';
const API_URL = 'http://lbapiby.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[--AIvin--DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[--AIvin--DEBUG] ${message}: ${error.message || error}`);
};
