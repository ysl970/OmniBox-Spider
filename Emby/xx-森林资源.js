...
const API_HOST = 'https://beiyong.slapibf.com';
const API_URL = 'https://beiyong.slapibf.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[森林资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[森林资源-DEBUG] ${message}: ${error.message || error}`);
};
