...
const API_HOST = 'https://www.msnii.com';
const API_URL = 'https://www.msnii.com/api/json.php';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[-美少女--DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[-美少女--DEBUG] ${message}: ${error.message || error}`);
};
