...
const API_HOST = 'https://hsckzy.xyz';
const API_URL = 'https://hsckzy.xyz/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[黄色仓库-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[黄色仓库-DEBUG] ${message}: ${error.message || error}`);
};
