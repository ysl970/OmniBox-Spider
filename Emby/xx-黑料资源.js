...
const API_HOST = 'https://www.heiliaozyapi.com';
const API_URL = 'https://www.heiliaozyapi.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[黑料资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[黑料资源-DEBUG] ${message}: ${error.message || error}`);
};
