...
const API_HOST = 'https://apilj.com';
const API_URL = 'https://apilj.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[辣椒资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[辣椒资源-DEBUG] ${message}: ${error.message || error}`);
};
