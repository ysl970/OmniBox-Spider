...
const API_HOST = 'https://xingba222.com';
const API_URL = 'https://xingba222.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[杏吧资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[杏吧资源-DEBUG] ${message}: ${error.message || error}`);
};
