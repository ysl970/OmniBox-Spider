...
const API_HOST = 'https://www.xxibaozyw.com';
const API_URL = 'https://www.xxibaozyw.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[细胞资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[细胞资源-DEBUG] ${message}: ${error.message || error}`);
};
