...
const API_HOST = 'https://ckzy.me';
const API_URL = 'https://ckzy.me/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[CK-资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[CK-资源-DEBUG] ${message}: ${error.message || error}`);
};
