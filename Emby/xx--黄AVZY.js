...
const API_HOST = 'https://www.pgxdy.com';
const API_URL = 'https://www.pgxdy.com/api/json.php';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[-黄AVZY-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[-黄AVZY-DEBUG] ${message}: ${error.message || error}`);
};
