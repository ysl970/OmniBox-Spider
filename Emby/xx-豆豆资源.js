...
const API_HOST = 'https://api.douapi.cc';
const API_URL = 'https://api.douapi.cc/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[豆豆资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[豆豆资源-DEBUG] ${message}: ${error.message || error}`);
};
