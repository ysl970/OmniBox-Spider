...
const API_HOST = 'https://www.xiangjiaozyw.com';
const API_URL = 'https://www.xiangjiaozyw.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[香蕉资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[香蕉资源-DEBUG] ${message}: ${error.message || error}`);
};
