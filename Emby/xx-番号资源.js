...
const API_HOST = 'https://fhapi9.com';
const API_URL = 'http://fhapi9.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[番号资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[番号资源-DEBUG] ${message}: ${error.message || error}`);
};
