...
const API_HOST = 'https://siwazyw.tv';
const API_URL = 'https://siwazyw.tv/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[丝袜资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[丝袜资源-DEBUG] ${message}: ${error.message || error}`);
};
