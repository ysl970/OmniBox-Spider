...
const API_HOST = 'https://apiyutu.com';
const API_URL = 'https://apiyutu.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[玉兔资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[玉兔资源-DEBUG] ${message}: ${error.message || error}`);
};
