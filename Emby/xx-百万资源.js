...
const API_HOST = 'https://api.bwzyz.com';
const API_URL = 'https://api.bwzyz.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[百万资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[百万资源-DEBUG] ${message}: ${error.message || error}`);
};
