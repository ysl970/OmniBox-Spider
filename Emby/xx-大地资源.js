...
const API_HOST = 'https://dadiapi.com';
const API_URL = 'https://dadiapi.com/feifei';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[大地资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[大地资源-DEBUG] ${message}: ${error.message || error}`);
};
