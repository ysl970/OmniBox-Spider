...
const API_HOST = 'https://aosikazy.com';
const API_URL = 'https://aosikazy.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[-奥斯卡--DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[-奥斯卡--DEBUG] ${message}: ${error.message || error}`);
};
