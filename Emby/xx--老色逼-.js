...
const API_HOST = 'https://apilsbzy1.com';
const API_URL = 'https://apilsbzy1.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[-老色逼--DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[-老色逼--DEBUG] ${message}: ${error.message || error}`);
};
