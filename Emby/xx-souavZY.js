...
const API_HOST = 'https://api.souavzyw.net';
const API_URL = 'https://api.souavzyw.net/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[souavZY-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[souavZY-DEBUG] ${message}: ${error.message || error}`);
};
