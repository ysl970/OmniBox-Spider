...
const API_HOST = 'https://www.kxgav.com';
const API_URL = 'https://www.kxgav.com/api/json.php';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[白嫖资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[白嫖资源-DEBUG] ${message}: ${error.message || error}`);
};
