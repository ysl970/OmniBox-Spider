...
const API_HOST = 'https://Naixxzy.com';
const API_URL = 'https://Naixxzy.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[奶香资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[奶香资源-DEBUG] ${message}: ${error.message || error}`);
};
