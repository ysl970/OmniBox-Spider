...
const API_HOST = 'https://xzybb2.com';
const API_URL = 'https://xzybb2.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[-幸资源--DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[-幸资源--DEBUG] ${message}: ${error.message || error}`);
};
