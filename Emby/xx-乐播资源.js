...
const API_HOST = 'https://lbapi9.com';
const API_URL = 'https://lbapi9.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[乐播资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[乐播资源-DEBUG] ${message}: ${error.message || error}`);
};
