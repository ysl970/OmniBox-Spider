...
const API_HOST = 'https://jkunzyapi.com';
const API_URL = 'https://jkunzyapi.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[jkun资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[jkun资源-DEBUG] ${message}: ${error.message || error}`);
};
