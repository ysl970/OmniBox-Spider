...
const API_HOST = 'https://shayuapi.com';
const API_URL = 'https://shayuapi.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[鲨鱼资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[鲨鱼资源-DEBUG] ${message}: ${error.message || error}`);
};
