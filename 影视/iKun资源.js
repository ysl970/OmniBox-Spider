...
const API_HOST = 'https://ikunzyapi.com';
const API_URL = 'https://ikunzyapi.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[iKun资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[iKun资源-DEBUG] ${message}: ${error.message || error}`);
};
