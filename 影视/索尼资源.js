...
const API_HOST = 'https://suoniapi.com';
const API_URL = 'https://suoniapi.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[索尼资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[索尼资源-DEBUG] ${message}: ${error.message || error}`);
};
