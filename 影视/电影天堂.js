...
const API_HOST = 'https://caiji.dyttzyapi.com';
const API_URL = 'http://caiji.dyttzyapi.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[电影天堂-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[电影天堂-DEBUG] ${message}: ${error.message || error}`);
};
