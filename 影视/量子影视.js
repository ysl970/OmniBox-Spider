...
const API_HOST = 'https://cj.lziapi.com';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[量子影视-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[量子影视-DEBUG] ${message}: ${error.message || error}`);
};
