...
const API_HOST = 'https://caiji.maotaizy.cc';
const API_URL = 'https://caiji.maotaizy.cc/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[茅台资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[茅台资源-DEBUG] ${message}: ${error.message || error}`);
};
