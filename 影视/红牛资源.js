...
const API_HOST = 'https://www.hongniuzy2.com';
const API_URL = 'https://www.hongniuzy2.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[红牛资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[红牛资源-DEBUG] ${message}: ${error.message || error}`);
};
