...
const API_HOST = 'https://www.mdzyapi.com';
const API_URL = 'https://www.mdzyapi.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[魔都资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[魔都资源-DEBUG] ${message}: ${error.message || error}`);
};
