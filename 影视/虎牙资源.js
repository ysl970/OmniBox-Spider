...
const API_HOST = 'https://www.huyaapi.com';
const API_URL = 'https://www.huyaapi.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[虎牙资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[虎牙资源-DEBUG] ${message}: ${error.message || error}`);
};
