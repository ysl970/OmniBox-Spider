...
const API_HOST = 'https://p2100.net';
const API_URL = 'https://p2100.net/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[飘零资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[飘零资源-DEBUG] ${message}: ${error.message || error}`);
};
