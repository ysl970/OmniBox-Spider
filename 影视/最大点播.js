...
const API_HOST = 'https://zuidazy.me';
const API_URL = 'https://zuidazy.me/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[最大点播-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[最大点播-DEBUG] ${message}: ${error.message || error}`);
};
