...
const API_HOST = 'https://api.xinlangapi.com';
const API_URL = 'https://api.xinlangapi.com/xinlangapi.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[新浪资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[新浪资源-DEBUG] ${message}: ${error.message || error}`);
};
