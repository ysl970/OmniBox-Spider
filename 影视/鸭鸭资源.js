...
const API_HOST = 'https://cj.yayazy.net';
const API_URL = 'https://cj.yayazy.net/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[鸭鸭资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[鸭鸭资源-DEBUG] ${message}: ${error.message || error}`);
};
