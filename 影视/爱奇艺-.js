...
const API_HOST = 'https://iqiyizyapi.com';
const API_URL = 'https://iqiyizyapi.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[-爱奇艺--DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[-爱奇艺--DEBUG] ${message}: ${error.message || error}`);
};
