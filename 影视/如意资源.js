...
const API_HOST = 'https://cj.rycjapi.com';
const API_URL = 'https://cj.rycjapi.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[如意资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[如意资源-DEBUG] ${message}: ${error.message || error}`);
};
