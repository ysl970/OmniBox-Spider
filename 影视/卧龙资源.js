...
const API_HOST = 'https://wolongzyw.com';
const API_URL = 'https://wolongzyw.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[卧龙资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[卧龙资源-DEBUG] ${message}: ${error.message || error}`);
};
