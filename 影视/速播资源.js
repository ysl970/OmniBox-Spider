...
const API_HOST = 'https://subocaiji.com';
const API_URL = 'https://subocaiji.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[速播资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[速播资源-DEBUG] ${message}: ${error.message || error}`);
};
