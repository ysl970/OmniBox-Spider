...
const API_HOST = 'https://360zyzz.com';
const API_URL = 'https://360zyzz.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[360 资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[360 资源-DEBUG] ${message}: ${error.message || error}`);
};
