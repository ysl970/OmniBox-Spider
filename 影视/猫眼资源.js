...
const API_HOST = 'https://api.maoyanapi.top';
const API_URL = 'https://api.maoyanapi.top/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[猫眼资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[猫眼资源-DEBUG] ${message}: ${error.message || error}`);
};
