...
const API_HOST = 'https://caiji.moduapi.cc';
const API_URL = 'https://caiji.moduapi.cc/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[魔都动漫-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[魔都动漫-DEBUG] ${message}: ${error.message || error}`);
};
