...
const API_HOST = 'https://xsd.sdzyapi.com';
const API_URL = 'https://xsd.sdzyapi.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[闪电资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[闪电资源-DEBUG] ${message}: ${error.message || error}`);
};
