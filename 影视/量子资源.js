...
const API_HOST = 'https://cj.lzcaiji.com';
const API_URL = 'https://cj.lzcaiji.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[量子资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[量子资源-DEBUG] ${message}: ${error.message || error}`);
};
