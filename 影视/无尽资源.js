...
const API_HOST = 'https://api.wujinapi.me';
const API_URL = 'https://api.wujinapi.me/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[无尽资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[无尽资源-DEBUG] ${message}: ${error.message || error}`);
};
