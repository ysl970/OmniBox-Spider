...
const API_HOST = 'https://caiji.dbzy5.com';
const API_URL = 'https://caiji.dbzy5.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[豆瓣资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[豆瓣资源-DEBUG] ${message}: ${error.message || error}`);
};
