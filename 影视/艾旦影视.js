...
const API_HOST = 'https://lovedan.net';
const API_URL = 'https://lovedan.net/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[艾旦影视-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[艾旦影视-DEBUG] ${message}: ${error.message || error}`);
};
