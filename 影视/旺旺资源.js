...
const API_HOST = 'https://api.wwzy.tv';
const API_URL = 'https://api.wwzy.tv/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[旺旺资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[旺旺资源-DEBUG] ${message}: ${error.message || error}`);
};
