...
const API_HOST = 'https://jszyapi.com';
const API_URL = 'https://jszyapi.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[极速资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[极速资源-DEBUG] ${message}: ${error.message || error}`);
};
