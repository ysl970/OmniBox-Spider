...
const API_HOST = 'https://api.wujinapi.com';
const API_URL = 'https://api.wujinapi.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[无尽影视-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[无尽影视-DEBUG] ${message}: ${error.message || error}`);
};
