...
const API_HOST = 'https://api.yzzy-api.com';
const API_URL = 'https://api.yzzy-api.com/inc/apijson.php';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[优质资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[优质资源-DEBUG] ${message}: ${error.message || error}`);
};
