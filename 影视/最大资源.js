...
const API_HOST = 'https://api.zuidapi.com';
const API_URL = 'https://api.zuidapi.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[最大资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[最大资源-DEBUG] ${message}: ${error.message || error}`);
};
