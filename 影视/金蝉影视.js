...
const API_HOST = 'https://zy.jinchancaiji.com';
const API_URL = 'https://zy.jinchancaiji.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[金蝉影视-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[金蝉影视-DEBUG] ${message}: ${error.message || error}`);
};
