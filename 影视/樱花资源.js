...
const API_HOST = 'https://m3u8.apiyhzy.com';
const API_URL = 'https://m3u8.apiyhzy.com/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[樱花资源-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[樱花资源-DEBUG] ${message}: ${error.message || error}`);
};
