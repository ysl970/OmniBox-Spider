...
const API_HOST = 'https://wwzy.tv';
const API_URL = 'https://wwzy.tv/api.php/provide/vod';
...
const logInfo = (message, data = null) => {
    ...
    OmniBox.log("info", `[旺旺短剧-DEBUG] ${output}`);
};

const logError = (message, error) => {
    OmniBox.log("error", `[旺旺短剧-DEBUG] ${message}: ${error.message || error}`);
};
